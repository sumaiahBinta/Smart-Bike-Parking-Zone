...
pinMode(ir_bike1, INPUT);
pinMode(ir_bike2, INPUT);
pinMode(ir_bike3, INPUT);
pinMode(ir_bike4, INPUT);
...
if(digitalRead(ir_bike1) == 0){S1=1;}
if(digitalRead(ir_bike2) == 0){S2=1;}
if(digitalRead(ir_bike3) == 0){S3=1;}
if(digitalRead(ir_bike4) == 0){S4=1;}
